...
<main>
    ...
    <section class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ?'bg-gradient-blue-to-bottom-50 pt-12 pb-16':'bg-gradient-blue-to-bottom-150 py-[50px]' ?>">
        <div class="container">
                ...
                <div class="flex-1">
					...
					{ ?>
						<div class="toggle-form mb-[12px] inline-block">
							<div class="">
								<p class="inline-flex items-baseline gap-2 font-medium">Thu gọn <?php echo svgClass('down','','','rotate-180') ?></p>
							</div>
							<div class="hidden">
								<p class="inline-flex items-baseline gap-2 font-medium">Mở rộng <?php echo svg('down') ?></p>
							</div>
						</div>
					<?php } ?>
                    <form method="get"
						action="<?php echo get_term_link( get_queried_object() ); ?>">
						<div class="flex  mb-12 flex-wrap <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'flex-nowrap gap-5':'' ?>">
							<div
								...
								<div class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ?'':'w-5 h-5' ?> shrink-0">
							...
							<div class="flex gap-4 flex-1">
								...
								<?php } ?>
								<div class=" flex items-center gap-3 <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'2xl:w-[55%] w-1/2':'w-full mt-[12px]' ?>">
									<button type="submit"
                        ...
                        if ($response) :
                            ...
                            $total_page = ceil($total_post / $post_per_page);
                        ?>
                            <div class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ?'space-y-8':'space-y-6' ?>">
                                <?php
                                foreach ($response->d as $news) {
