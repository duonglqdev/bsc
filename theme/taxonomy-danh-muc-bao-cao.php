				...
				<div class="flex-1">
					<?php if (get_field('type_danh_muc', get_queried_object()) == 'avatar') { ?>
						...
						?>
							<div class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ? 'space-y-8' : 'mt-8'; ?>">
								...
								?>
									<div class="px-6 py-[12px] btn-base-yellow text-xs font-bold text-center flex items-center justify-center gap-2 show-item-btn mt-8">
					...
					?>
						...
						?>
							...
							<div
								class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-8' : 'space-y-6 mt-6' ?>">
								<?php
								foreach ($response->d as $news) {
