		...
		<div class="container">
			...
			<div
				...
				<div class="flex-1 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'max-w-[75%]' : 'relative' ?>">
								...
								<div id="date-range-picker" date-rangepicker datepicker-format="dd/mm/yyyy"
									...
									<div class="flex items-center gap-1">
										<input id="datepicker-range-start" name="fromdate" type="text"
											class="border-none focus:border-none focus:outline-0 focus:ring-0 2xl:max-w-[90px] xl:max-w-[80px] 2xl:text-base text-xs p-0"
								...
								<div
									...
									<div id="date-range-picker" date-rangepicker datepicker-format="dd/mm/yyyy"
										...
										<div class="flex items-center 2xl:gap-5 gap-3">
											<input id="datepicker-range-start" name="fromdate" type="text"
												class="border-none focus:border-none focus:outline-0 focus:ring-0 2xl:max-w-[100px] 2xl:text-base text-xs p-0"
					...
					?>
					<?php
					if (have_rows('display_table_chart', get_queried_object())) {
						while (have_rows('display_table_chart', get_queried_object())): the_row();
							$type_danh_muc = get_sub_field('table_chart');
							$url_type_loai_danh_muc = get_sub_field('link');
