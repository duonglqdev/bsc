...
function bsc_scripts() {
	...
	wp_enqueue_script( 'bsc-js-slick', get_template_directory_uri() . '/assets/libs/slick.min.js', array(), bsc_VERSION, true );
	...
	wp_localize_script( 'bsc-script', 'ajaxurl', admin_url('admin-ajax.php'));
 ...
 */
function bsc_enqueue_block_editor_script() {
	wp_enqueue_script(
		'bsc-editor',
...
add_action( 'enqueue_block_editor_assets', 'bsc_enqueue_block_editor_script' );

/**
 * Enqueue the script necessary to support Tailwind Typography in the block
 * editor, using an inline script to create a JavaScript array containing the
 * Tailwind Typography classes from bsc_TYPOGRAPHY_CLASSES.
 */
function bsc_enqueue_typography_script() {
	if ( is_admin() ) {
		wp_enqueue_script(
			'bsc-typography',
		...
		wp_add_inline_script( 'bsc-typography', "tailwindTypographyClasses = '" . esc_attr( bsc_TYPOGRAPHY_CLASSES ) . "'.split(' ');", 'before' );
	}
}
add_action( 'enqueue_block_assets', 'bsc_enqueue_typography_script' );
 ...
 * @return array
 */
function bsc_tinymce_add_class( $settings ) {
	$settings['body_class'] = bsc_TYPOGRAPHY_CLASSES;
	return $settings;
}
add_filter( 'tiny_mce_before_init', 'bsc_tinymce_add_class' );
