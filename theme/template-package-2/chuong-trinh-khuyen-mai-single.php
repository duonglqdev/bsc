...
/**
Template Name: [Package-2] Chi tiết chương trình KM
 */
...
<main>
		...
		<div class="container">
			<div class="lg:flex gap-[70px]">
				...
				<div class="flex-1">
					...
					<div class="text-[#4A5568] font-Helvetica the_content">
						<p>
							Với mục tiêu nâng cao trải nghiệm tài chính cho các nhà đầu tư, từ ngày
							16/09/2024, CTCP Chứng khoán BIDV (BSC) kết hợp cùng FireAnt, hân hạnh
	...
	<section class="xl:my-[100px] my-20">
		<div class="container">
			<h2 class="heading-title mb-10">KHUYẾN MÃI LIÊN QUAN</h2>
