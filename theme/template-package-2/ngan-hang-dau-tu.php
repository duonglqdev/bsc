...
<main>
	...
	<!-- Tab nav -->
	<section
		class="bg-primary-50 sticky z-10 top-0 menu_navigation <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '2xl:py-4 py-3' : 'py-[12px]' ?>">
		<div class="container">
			<ul
	...
	for ( $j = 1; $j < 5; $j++ ) {
		?>
		<section class="<?php echo $j == 1 ? 'block' : 'hidden' ?> tab-content" id="bank-tab-<?php echo $j ?>">
			<div
				class="content_image <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:my-[100px] lg:my-20 my-[50px]' : 'my-[50px]' ?>">
				<div class="container">
					<div
						...
						<div class="col-span-1 xl:pr-[42px]">
							...
							<?php if ( ! wp_is_mobile() && ! bsc_is_mobile() ) { ?>
								<div class="mt-8">
									<a href="" class="btn-base-yellow px-6 py-4 inline-flex items-center gap-x-3">
			...
			<div
				class="bg-[#F3F9FC] slider_customer <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:py-[121px] py-20' : 'py-[37.35px]' ?>">
				<div class="container">
					...
					<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'max-w-[1190px] mx-auto' : '' ?>">
						<div
							class=" block__slider-marquee <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'block_slider-show-6' : 'block_slider-show-3' ?>">
							<?php
							for ( $i = 0; $i < 12; $i++ ) {
								?>
								<div
									class="block_slider-item lg:w-1/6 md:w-1/4 w-1/3 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'py-[12px] mx-[12px]' : 'py-2 mx-[7px]' ?>">
									<a href="<?php echo check_link( get_sub_field( 'link' ) ) ?>"
										...
										<img loading="lazy"
											src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bidv.png" alt=""
						...
						<div
							class="block__slider-marquee marquee-rtl <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'block_slider-show-6' : 'block_slider-show-3' ?>">
							<?php
							for ( $i = 0; $i < 12; $i++ ) {
								?>
								<div
			...
			<div
				class="reward_feature <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:my-[100px] my-20' : 'my-[50px]' ?>">
				<div class="container">
						...
						<div
							...
							<div
								...
								<div class="mb-4 hide-open hidden">
									<img loading="lazy"
										src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/aw.svg" alt=""
										class="max-w-10 h-auto object-contain w-full">
								</div>
								...
								<div
									...
									<div class="relative w-full pt-[124%]">
										<img loading="lazy"
											src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/aw1.png" alt=""
							...
							<div
								...
								<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'max-w-[470px]' : 'w-full' ?>">
									<h3
										class="font-bold mb-4 font-body <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '2xl:text-2xl text-xl' : 'text-lg text-center' ?>">
						...
						<div
							...
							<div
								...
								<div class="mb-4 hide-open">
									<img loading="lazy"
										src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/aw.png" alt=""
										class="max-w-10 h-auto object-contain w-full">
								</div>
								...
								<div
									...
									<div class="relative w-full pt-[124%]">
										<img loading="lazy"
											src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/aw2.png" alt=""
											class="absolute w-full h-full inset-0 object-contain transition-all">
									</div>
								</div>
						...
						<div
							...
							<div
								...
								<div
									...
									<div class="relative w-full pt-[124%]">
										<img loading="lazy"
											src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/aw3.png" alt=""
											class="absolute w-full h-full inset-0 object-contain transition-all">
									</div>
								</div>
								<div class="mt-6 hide-open arr">
			...
			<div
				class="bg-gradient-blue-250 nhdt_contact <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'py-20' : 'py-8' ?>">
				<div class="container">
					<div class=" <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:flex' : '' ?>">
						<div
							class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '2xl:pr-[50px] pr-10 lg:w-[575px] lg:max-w-[43%] shrink-0' : '' ?>">
							<h2
								class="heading-title <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '2xl:mb-[72px] mb-10' : 'mb-6' ?>">
								LIÊN HỆ TƯ VẤN
							</h2>
							<?php if ( ! wp_is_mobile() && ! bsc_is_mobile() ) { ?>
								<div class="relative w-full pt-[66.666%] overflow-hidden rounded-[10px]">
									<img loading="lazy"
										src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/img-contact.png" alt=""
										class="absolute w-full h-full inset-0 object-cover transition-all duration-500 hover:scale-105">
								</div>
							<?php } ?>
						</div>
						<div
							class="flex-1 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '2xl:pl-[50px] lg:pl-10 lg:border-l border-[#D2D2D2] lg:mt-0 mt-8' : '' ?>">
							<h3
								class="text-primary-300 font-bold <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'mb-6 xl:text-2xl text-xl ' : 'mb-4' ?>">
								<?php _e( 'Đăng ký thông tin hỗ trợ', 'bsc' ) ?>
							</h3>
							<div
