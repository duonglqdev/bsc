...
<main>
	...
	<section class="contact_content <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'my-16' : 'my-[50px]' ?>">
		<div class="container">
			<div
		...
		<div class="container">
			...
			<div
				...
				<div class="space-y-2">
					...
					<select
						class="select_custom  py-0 border-[#EAEEF4] h-[38px] max-w-full <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'rounded-[10px] pl-5' : 'w-full rounded-lg pl-3 text-xs' ?>">
				...
				<div class="space-y-2">
					...
					<select
						class="select_custom py-0 border-[#EAEEF4] h-[38px] max-w-full <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'rounded-[10px]' : 'w-full rounded-lg pl-3 text-xs' ?>">
						<option value="">Tất cả</option>
