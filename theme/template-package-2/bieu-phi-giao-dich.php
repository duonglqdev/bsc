	...
	<section class="mt-14 xl:mb-[100px] mb-20">
		<div class="container">
			<div class="lg:flex gap-20">
				<div
					class=" <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:w-[340px] max-w-[35%] shrink-0' : 'relative' ?>">
					<?php if ( ! wp_is_mobile() && ! bsc_is_mobile() ) : ?>
						<div class="sticky z-[9] <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:top-28' : '' ?>">
				...
				<div class="flex-1 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '' : 'mt-6' ?>">
					...
					<div
						...
						<div class="table__item mb-10">
							<ul
								class="pl-5 list-disc  font-bold  <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'text-xl mb-6' : 'mb-4' ?>">
								<li>
							...
							<div
								class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '' : 'overflow-x-auto text-xxs' ?>">
								<table>
									<thead>
										<tr>
											<th rowspan="2"
												class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'w-[7.313%] px-0' : 'px-2 whitespace-nowrap w-[50px]' ?>">
												STT
											</th>
											<th rowspan="2"
												class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'w-[36.72%]' : 'w-[158px]' ?>">
												Tổng giá trị giao dịch/
												ngày/ tài khoản</th>
											<th colspan="2"
												class="!py-2 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'w-[55.93%]' : 'w-[320px]' ?>">
												Mức phí (VNĐ)</th>
										</tr>
										<tr>
						...
						<div class="table__item mb-10">
							...
							<table>
								<thead>
									<tr>
										<th rowspan="2"
											class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'w-[7.313%] px-0' : 'w-[50px] whitespace-nowrap' ?>">
											STT
										</th>
										<th rowspan="2"
											class=" <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'w-[36.72%]' : 'w-1/2' ?>">
											Tổng giá trị giao dịch/ ngày/ tài khoản </th>
										<th rowspan="2"
											class="!py-2 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'w-[55.93%]' : 'w-1/2' ?>">
											Mức phí (VNĐ)</th>
									</tr>
								</thead>
								<tbody>
					...
					<div class=" <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'mt-10 text-right' : 'mt-6' ?>">
						<a href="<?php the_field( 'duong_dan_tai_file' ) ?>"
							class=" px-6 py-3 btn-base-yellow <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'inline-block' : 'block text-xs text-center' ?>"
							target="_blank">
