...
<main>
	...
	<section
		class="bg-gradient-blue-50 <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:py-16 py-12' : 'py-[50px]' ?>">
		<div class="container">
			<form class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'mx-auto max-w-[950px] flex gap-4' : '' ?>"
				id="seach_support-content">
				<div
			...
			<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'mt-16' : 'mt-8' ?>">
				...
				<div
					class="grid <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:grid-cols-3 grid-cols-2 lg:gap-12 gap-10' : 'gap-6' ?>">
					<?php
					for ( $i = 0; $i < 7; $i++ ) {
						?>
						<div
							class="font-Helvetica <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-4' : 'space-y-3' ?>">
							<h4
								class="font-bold <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:text-2xl text-xl' : 'flex items-center justify-between text-lg' ?>">
								Mở tài khoản
								<?php if ( wp_is_mobile() && bsc_is_mobile() ) { ?>
									<a href="#"
							...
							<ul
								class="pl-5 list-disc text-primary-300  <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'text-lg' : '' ?>">
								<li>
									<a href="" class="hover:text-primary-600 transition-all duration-500">
				...
				<div class="md:col-span-3 col-span-full">
					<div class="group">
						<a href="https://youtu.be/v-S2oFvblgw?si=2aeRx1owiG1ETA5e"
							...
							data-fancybox="">
							<img loading="lazy"
								src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/news.jpg" alt=""
	...
	<section class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '2xl:my-[100px] my-10' : 'my-[50px]' ?>">
		<div class="container">
			<div
				class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'flex items-center justify-between mb-12' : 'mb-6' ?>">
			...
			<div
				class="block_slider <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'block_slider-show-3 -mx-[12px] has-nav no-dots' : 'block_slider-show-1 fli-dots-blue dot-30' ?>">
				<?php
				for ( $i = 0; $i < 6; $i++ ) {
					?>
					<div
						class="block_slider-item  <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:w-1/3 md:w-1/2 px-[12px]' : 'w-full' ?>">
						<a href="https://youtu.be/v-S2oFvblgw?si=2aeRx1owiG1ETA5e" data-fancybox
							...
							<img loading="lazy"
								src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/image-video.png" alt=""
		...
		<div class="container">
			<div class="lg:flex">
				...
				<div class="flex-1 2xl:pl-[50px] pl-10 lg:border-l border-[#D2D2D2]">
					...
					<div class="form_support relative font-Helvetica bg-white lg:px-8 px-5 lg:py-6 py-4 rounded-2xl">
