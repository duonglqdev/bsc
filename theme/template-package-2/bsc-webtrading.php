...
/**
Template Name: [Package-2] BSC webtrading
 */
			...
			<div class="space-y-10 max-w-[1115px] mx-auto">
				<div class="md:flex gap-5 items-center">
					...
					<div class="md:w-1/2">
						...
						<p class="text-primary-300 text-2xl font-bold mb-6">
							ProTrading – Đặt lệnh chuyên sâu
						</p>
						<div class="font-Helvetica">
							Nền tảng đa nhiệm, Giao diện tùy biến, Tối ưu UI/UX, Đa ngôn ngữ
						</div>
					</div>
				</div>
				<div class="md:flex gap-5 items-center flex-row-reverse">
					...
					<div class="md:w-1/2">
						...
						<div class="font-Helvetica">
							Giao dịch chỉ với 1 chạm, Đặt lệnh nhanh chóng với màn hình ProTrading
						</div>
					</div>
				</div>
				<div class="md:flex gap-5 items-center">
					...
					<div class="md:w-1/2">
						...
						<div class="font-Helvetica">
							Chuyên mục thị trường, Danh mục khuyến nghị, Bộ lệnh điều kiện
						</div>
					</div>
				</div>
			</div>
	...
	<section class="xl:my-[100px] my-20">
		<div class="container">
			<h2 class="heading-title mb-10">
				HƯỚNG DẪN SỬ DỤNG BSC WEB TRADING
			</h2>
