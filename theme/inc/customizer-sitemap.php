...
add_action( 'init', function () {
	...
	if ( strpos( $_SERVER['REQUEST_URI'], '/sitemap_index.xml' ) !== false ) {
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/danh-muc-bao-cao-phan-tich-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/kien-thuc-dau-tu-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/danh-muc-kien-thuc-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/quan-he-co-dong-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/danh-muc-bao-cao-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/so-tay-giao-dich-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		...
		<?php
		exit;
	} elseif ( strpos( $_SERVER['REQUEST_URI'], '/tuyen-dung-sitemap.xml' ) !== false ) {
		header( 'Content-Type: application/xml; charset=utf-8' );
		echo '<?xml version="1.0" encoding="UTF-8"?>';
		?>
		<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
