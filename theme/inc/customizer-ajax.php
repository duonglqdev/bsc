...
function filter_details_symbol() {
		...
		if ( $response_GetNews ) { ?>
			...
			foreach ( $response_GetNews->d as $news ) {
				...
				<div class="news_service-item document_item-popup" data-newstype="1" data-modal-target="document-modal"
					data-modal-toggle="document-modal" data-doccument="<?php echo $news->attachedfileurl ?>"
									...
									<div
										...
										<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
											...
											<div class="legend-gap bsc_chart-display" data-load="false" data-end="%"
												...
												data-title-2="<?php _e( 'ROE trung bình ngành', 'bsc' ) ?>" data-color-2="#FFB81C">
											</div>
										</div>
									</div>
								</article>
										...
										<?php if ( $check_linh_vuc == 'Bank' ) { ?>
											<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
												...
												<div class="legend-gap bsc_chart-display" data-load="false"
													...
													data-title-2="<?php _e( 'Tỷ lệ nợ  xấu trung bình ngành', 'bsc' ) ?>" data-color-1="#235BA8"
													data-color-2="#FFB81C">
												</div>
											</div>
											<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
											...
											<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
												...
												<div class="legend-gap bsc_chart-display" data-load="false"
													...
													data-title-2="<?php _e( 'TLDP nợ xấu trung bình ngành', 'bsc' ) ?>" data-color-1="#235BA8"
													data-color-2="#FFB81C">
												</div>
											</div>
										...
										<?php if ( $check_linh_vuc == 'Bank' ) { ?>
											<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
												...
												<div class="legend-gap bsc_chart-display" data-load="false"
													...
													data-title-2="<?php _e( 'Tỷ lệ chi phí trung bình ngành', 'bsc' ) ?>" data-color-1="#009e87"
													data-color-2="#FFB81C">
												</div>
											</div>
											<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
												...
												<div class="legend-gap bsc_chart-display" data-load="false"
													...
													data-title-2="<?php _e( 'TN từ Lãi vay trung bình ngành', 'bsc' ) ?>" data-color-1="#009e87"
													data-color-2="#FFB81C">
												</div>
											</div>
											<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-6' : 'space-y-4' ?>">
												...
												<div class="legend-gap bsc_chart-display" data-load="false"
													...
													data-title-2="<?php _e( 'CASA trung bình ngành', 'bsc' ) ?>" data-color-1="#009e87"
													data-color-2="#FFB81C">
												</div>
											</div>
										<?php } elseif ( $check_linh_vuc == 'Securities' ) { ?>
	...
	<?php
		...
		if ( $response_GetAllDanhMuc ) {
			...
			foreach ( $response_GetAllDanhMuc->d as $news ) {
				$i++; ?>
				<div class="tab-content <?php echo $i == 1 ? 'block' : 'hidden' ?>" id="<?php echo $tab ?>-<?php echo $i ?>">
					<div
