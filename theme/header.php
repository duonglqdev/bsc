			...
			<div class="container">
				<div class="lg:flex lg:justify-between lg:items-center lg:gap-3">
					...
					<div class="relative lg:flex items-center">
						...
						<ul
							class="main_menu-navbar lg:bg-[#F3FBFE] w-full lg:absolute lg:shadow-menu lg:shadow-[#0000001A] lg:rounded-br-2xl lg:rounded-bl-2xl bg-gradient-menu top-full lg:mt-[22px] lg:p-10 lg:backdrop-blur-2xl">
