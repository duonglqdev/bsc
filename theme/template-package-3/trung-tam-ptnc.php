		...
		<div class="container">
			<div
				...
				<div
					...
					for ( $i = 1; $i < 4; $i++ )
					{
						...
						<div class="tab-content <?php echo $i == 1 ? 'block' : 'hidden' ?>"
							id="tab-<?php echo $i ?>">
							<div
								class="rounded-lg overflow-hidden relative <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? ' relative 2xl:pt-[76.2416%] pt-[80%] w-full' : 'text-xs' ?>">
								<!-- Nếu đã đăng nhập thì bỏ class blur-sm -->
								<div
									class="blur-sm <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'absolute w-full h-full inset-0' : 'overflow-x-auto scroll-bar-custom scroll-bar-x' ?>">
									<ul
								...
								<div
									...
									<a href="#"
										class="bg-yellow-100 text-black hover:shadow-[0px_4px_16px_0px_rgba(255,184,28,0.5)] hover:bg-[#ffc547] inline-block 2xl:px-8 px-4 2xl:py-4 py-2  relative transition-all duration-500 font-bold lg:rounded-xl rounded-md">
										Đăng nhập
									</a>
				...
				<div
						...
						<div
							...
							<div
								...
								<div
									...
									<div class="flex-1 text-right pr-3 font-semibold">
										<p>23,839</p>
									</div>
								</div>
							</div>
					...
					<div
						class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'mt-6' : 'mt-[50px]' ?>">
