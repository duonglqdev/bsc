...
<main>
	...
	<section
		...
		<div class="container">
			...
			<div
				...
				<div
					class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:w-[547px] xl:max-w-[41%] w-full' : 'w-full block_slider-item ' ?>">
					<div
				...
				<div
					class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:w-[433px] xl:max-w-[33%] w-1/2' : 'w-full block_slider-item ' ?>">
					<div
	...
	<section
		class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'xl:my-[80px] my-20' : 'mt-16 mb-[50px]' ?>">
		<div class="container">
			<ul
				...
				<li
					...
					<button data-tabs="#tab-1"
						class="active inline-flex items-center gap-2 transition-all duration-500 py-6 lg:text-xl font-bold uppercase [&:not(.active)]:text-black text-primary-300 [&:not(.active)]:opacity-70 opacity-100 relative after:absolute after:w-full after:h-0.5 after:bottom-0 after:left-0 after:transition-all after:duration-500 [&:not(.active)]:after:opacity-0 after:opacity-100 after:bg-primary-300 hover:!text-primary-300 hover:!opacity-100 hover:after:!opacity-100">
						TỔNG QUAN
					</button>
				</li>
				<li
					...
					<button data-tabs="#tab-2"
						class="inline-flex items-center gap-2 transition-all duration-500 py-6 lg:text-xl font-bold uppercase [&:not(.active)]:text-black text-primary-300 [&:not(.active)]:opacity-70 opacity-100 relative after:absolute after:w-full after:h-0.5 after:bottom-0 after:left-0 after:transition-all after:duration-500 [&:not(.active)]:after:opacity-0 after:opacity-100 after:bg-primary-300 hover:!text-primary-300 hover:!opacity-100 hover:after:!opacity-100">
						BÁO CÁO TÀI CHÍNH
					</button>
				</li>
				<li
				...
				<li
					...
					<button data-tabs="#tab-4"
						class="has-icon inline-flex items-center gap-2 transition-all duration-500 py-6 lg:text-xl font-bold uppercase [&:not(.active)]:text-black text-primary-300 [&:not(.active)]:opacity-70 opacity-100 relative after:absolute after:w-full after:h-0.5 after:bottom-0 after:left-0 after:transition-all after:duration-500 [&:not(.active)]:after:opacity-0 after:opacity-100 after:bg-primary-300 hover:!text-primary-300 hover:!opacity-100 hover:after:!opacity-100">
				...
				<div
					...
					<div
						...
						<div
							...
							<div class="xl:space-y-4 md:space-y-0 space-y-4 xl:block md:grid md:grid-cols-2 gap-4">
								<?php
								for ( $i = 0; $i < 3; $i++ )
								{
									?>
			...
			<div class="tab-content hidden" id="tab-2">
				<div class="list__content">
					...
					<!-- <div class="wrapper-scroll <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'space-y-16' : 'space-y-10' ?>">
						<div class="overflow-hidden">
							<div class="overflow-x-auto whitespace-nowrap sm:text-base text-xs scroll-item">
								<table
					...
					<div class="space-y-10 wrapper-scroll">
						<div class="overflow-hidden">
							<div class="overflow-x-auto whitespace-nowrap sm:text-base text-xs scroll-item">
								<table
									class="w-full max-w-full prose-thead:font-bold prose-th:text-left font-medium prose-th:p-[12px] prose-td:p-[12px]">
									<thead class="sticky z-[99] bg-white top-0">
										<tr>
											<th class="lg:min-w-[231px] lg:!w-1/4 "></th>
											<th class="lg:min-w-[140px] font-bold flex-1 ">
												<p class="text-right">Q3/2023</p>
												<p class="text-[#1CCD83] text-right">
													(Chưa kiểm toán) </p>
											</th>
											<th class="lg:min-w-[140px] font-bold flex-1 ">
												<p class="text-right">Q4/2023</p>
												<p class="text-[#1CCD83] text-right">
													(Chưa kiểm toán) </p>
											</th>
											<th class="lg:min-w-[140px] font-bold flex-1 ">
												<p class="text-right">Q1/2024</p>
												<p class="text-[#1CCD83] text-right">
													(Chưa kiểm toán) </p>
											</th>
											<th class="lg:min-w-[140px] font-bold flex-1 ">
												<p class="text-right">Q2/2024</p>
												<p class="text-[#1CCD83] text-right">
													(Đã kiểm toán) </p>
											</th>
											<th class="lg:min-w-[140px] font-bold flex-1 ">
												<p class="text-right">Q3/2024</p>
												<p class="text-[#1CCD83] text-right">
													(Chưa kiểm toán) </p>
											</th>
