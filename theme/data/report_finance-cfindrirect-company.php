...
return [ 
		...
		'children' => [ 
			...
			[ 
				...
				'children' => [ 
					...
					[ 
						'title' => '- ' . __( 'Tăng, giảm các khoản phải trả (Không kể lãi vay phải trả, thuế thu nhập doanh nghiệp phải nộp)', 'bsc' ),
						'order' => 13,
						'children' => [],
					],
					[ 
	...
	[ 
		...
		'children' => [ 
			...
			[ 
				'title' => '7. ' . __( 'Tiền thu từ vốn góp của cổ đông không kiểm soát', 'bsc' ),
				'order' => 36,
				'children' => [],
			],
		],
