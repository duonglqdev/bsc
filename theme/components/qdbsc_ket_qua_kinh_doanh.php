			...
			if ( $response_GetForecastBussinessResults )
			{
				...
				<div
					...
					<div class="overflow-x-auto scroll-bar-custom scroll-bar-x">
						<div
							class="text-white bg-primary-300 font-semibold flex items-center min-h-[60px] leading-[1.5] text-center sticky top-0 z-10 scroll-container-header w-max">
							<div
							...
							<div
								...
								<button data-tooltip-target="tooltip-animation1" data-tooltip-placement="bottom"
							...
							<div
								...
								<button data-tooltip-target="tooltip-animation2" data-tooltip-placement="bottom"
									class="ml-1" type="button">
									<?php echo svg( 'tooltip', '20', '20' ) ?>
								</button>
						...
						<div
							class="max-h-[600px] overflow-y-auto scroll-bar-custom scroll-bar-x scroll-container-content w-max">
							<?php
							$i = 0;
							$data = $response_GetForecastBussinessResults->d;
	
							// Sắp xếp theo trường 'symbol'
							...
							foreach ( $data as $GetForecastBussinessResults ) :
								...
								<ul
									...
									<li class="min-w-[120px] flex items-center justify-end pr-3 min-h-10">
									...
									<li
										class="lg:min-w-[90px] min-w-[110px] flex items-center justify-end pr-3 min-h-10">
									...
									<li
										class="2xl:min-w-[105px] min-w-[90px] flex items-center justify-end pr-3 min-h-10">
