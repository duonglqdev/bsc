<section class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ?'2xl:my-[100px] my-20':'my-[50px]' ?> about_culture" <?php if ( get_sub_field( 'id_class' ) )
{ ?> id="<?php echo get_sub_field( 'id_class' ) ?>" <?php } ?>>
	<div class="container">
		<?php if ( get_sub_field( 'title' ) )
		{ ?>
			<h2 class="heading-title text-center <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'mb-6':'mb-4' ?>">
		...
		{ ?>
			<div
				...
				<div class="absolute pointer-events-none  <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'-left-10 -top-5':'-top-8 left-0' ?>">
					<?php echo svg( 'quote' ) ?>
				</div>
