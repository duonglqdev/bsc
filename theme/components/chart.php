<section
	...
	<div class="container">
		...
		<div
			...
			<div
				...
				<div
					...
					if ( $response_GetAllDanhMuc )
					{
						...
						<div
							...
							<div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile()
								...
								{
									$i++; ?>
									<button data-chart="<?php echo $news->tendanhmuc ?>"
										data-stt="<?php echo $i ?>"
										class="<?php if ( $i == 1 )
					...
					<div class="flex-1 chart-info flex flex-col <?php echo ! wp_is_mobile() && ! bsc_is_mobile()
						...
						<div class="bsc-ajax-api h-full flex-1" data-api="chart"
							data-chart="running_chart">
							<div class="hidden">
								<div role="status">
			...
			<div
				class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'lg:w-[33.181%] w-full' : 'w-full' ?>">
				<div
