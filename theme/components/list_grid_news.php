        ...
        <div class="container">
            <div class="<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'flex lg:gap-[70px] gap-10' : '' ?>">
                    ...
                    <div class="w-80 max-w-[35%] shrink-0">
                        <div class="sticky top-5 z-10 ">
                            <ul class="shadow-base py-6 pr-4 rounded-lg bg-white scroll_nav space-y-2">
                                ...
                                ?>
                                    <li class="">
                                        <a href="#<?php echo urldecode(sanitize_title($term->slug)); ?>"
                ...
                <div class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ? 'flex-1' : 'space-y-8' ?>">
                    ...
                    foreach ($terms as $term) :
                    ?>
                        <div id="<?php echo urldecode(sanitize_title($term->slug)); ?>" class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ? '' : '[&:not(:last-child)]:pb-6 [&:not(:last-child)]:mb-6 [&:not(:last-child)]:border-b [&:not(:last-child)]:border-[#E1E1E1]' ?>">
