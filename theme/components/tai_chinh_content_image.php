<section class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ?'xl:my-[100px] my-20':'my-[50px]' ?> relative tai_chinh_content_image" <?php if (get_sub_field('id_class')) { ?> id="<?php echo get_sub_field('id_class') ?>" <?php } ?>>
    <div class="container">
        <div class="grid items-center <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'lg:grid-cols-2 grid-cols-3 ':'grid-cols-3' ?>">
            <div class="lg:col-span-1 md:col-span-2 col-span-full xl:-mr-[17px]">
                <div
