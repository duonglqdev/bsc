	...
	<div class="container">
		<div class="grid lg:grid-cols-2 2xl:gap-32 lg:gap-20 gap-10">
			<div class="col-span-1">
				<h2 class="heading-title mb-4">Mở tài khoản tại BSC</h2>
				<p class="uppercase text-primary-300 text-2xl font-bold mb-10">
					Dễ dàng - nhanh gọn - bảo mật
				</p>
				<a href=""
					...
					<span
						class="inline-flex items-center gap-x-3 relative z-10"><?php echo svg( 'arrow-btn', '20' ) ?>Mở
						tài khoản ngay</span>
				</a>
				<p class="mt-4">
					<a href=""
				...
				<div class="mt-8 relative z-10">
					...
					<img class="m-auto relative z-10"
						src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/offers.png"
						alt="">
