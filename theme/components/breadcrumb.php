	...
	if ( have_rows( 'cdtt1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdtt1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdtnvcd1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdtnvcd1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
...
} elseif ( ( $args['custom'] == 'tagbaocao' ) && get_field( 'cdbcpt1_breadcrumb_tag', 'option' ) ) {
	if ( have_rows( 'cdbcpt1_breadcrumb_tag', 'option' ) ) {
		?>
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdbcpt1_breadcrumb_tag', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
...
} elseif ( ( $args['custom'] == 'lichthitruong' ) && get_field( 'cdltt1_breadcrumb', 'option' ) ) {
	if ( have_rows( 'cdltt1_breadcrumb', 'option' ) ) {
		?>
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdltt1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdbcpt1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdbcpt1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdttcp1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdttcp1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
...
} elseif ( ( $args['custom'] == 'khuyennghi' ) && get_field( 'cddmkn1_breadcrumb', 'option' ) ) {
	if ( have_rows( 'cddmkn1_breadcrumb', 'option' ) ) {
		?>
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cddmkn1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdctkm1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdctkm1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdktdt1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdktdt1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
...
} elseif ( ( $args['custom'] == 'quanhe' ) && get_field( 'cdqhcd1_breadcrumb', 'option' ) ) {
	if ( have_rows( 'cdqhcd1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdqhcd1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdtd1_breacrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdtd1_breacrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdstgg1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdstgg1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
	...
	if ( have_rows( 'cdbdgg1_breadcrumb', 'option' ) ) {
		...
		<nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
			<p>
				<?php
				$i = 0;
				while ( have_rows( 'cdbdgg1_breadcrumb', 'option' ) ) :
					the_row();
					$i++; ?>
					<?php
					if ( $i != 1 ) {
