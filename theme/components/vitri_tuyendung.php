...
{ ?>
	...
	<div class="container">
					...
					<select id="nghiep_vu"
						...
						<?php foreach ( $nghiep_vus as $nghiep_vu ) :
							...
							<option value="<?php echo $nghiep_vu->term_id ?>">
								<?php echo esc_html( $nghiep_vu->name ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			<?php endif; ?>
					...
					<select id="noi_lam_viec"
						...
						<?php foreach ( $noi_lam_viecs as $noi_lam_viec ) :
							...
							<option value="<?php echo $noi_lam_viec->term_id ?>">
								<?php echo esc_html( $noi_lam_viec->name ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			<?php endif; ?>
		...
		if ( $filter_job->have_posts() ) : ?>
			...
			<div id="tuyen-dung-loading" class="hidden flex justify-center"><?php echo svg( 'loading' ) ?>
			</div>
		<?php endif;
		wp_reset_postdata(); ?>
