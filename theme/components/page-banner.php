...
} elseif (isset($args['breadcrumb']) && ($args['breadcrumb'] == 'post') || ($args['breadcrumb'] == 'congdong') || ($args['breadcrumb'] == 'kienthuc') || ($args['breadcrumb'] == 'khuyenmai') || ($args['breadcrumb'] == 'baocao') || ($args['breadcrumb'] == 'cophieu') || ($args['breadcrumb'] == 'tagbaocao')) {
