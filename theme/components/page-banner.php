...
if ( ( get_sub_field( 'background' ) || get_sub_field( 'background_mobile' ) ) && ( is_single() || is_page() || get_query_var( 'mck' ) ) ) {
	$banner = wp_get_attachment_image_url(
...
} elseif ( get_sub_field( 'title' ) && ( is_single() || is_page() || get_query_var( 'mck' ) ) ) {
