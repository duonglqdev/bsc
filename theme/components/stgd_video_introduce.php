<section class="<?php echo !wp_is_mobile() && !bsc_is_mobile() ?'mt-12 xl:mb-[100px] mb-20':'my-[50px]' ?> stgd_video_introduce" <?php if (get_sub_field('id_class')) { ?> id="<?php echo get_sub_field('id_class') ?>" <?php } ?>>
    <div class="container">
