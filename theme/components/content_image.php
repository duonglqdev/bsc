<div class="content_image <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'xl:my-[100px] lg:my-20 my-[50px]':'my-[50px]' ?>" <?php if (get_sub_field('id_class')) { ?> id="<?php echo get_sub_field('id_class') ?>" <?php } ?>>
    <div class="container">
