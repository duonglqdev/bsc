...
?>
	<div
		class="flex flex-col font-Helvetica h-full<?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? '' : 'w-full block_slider-item' ?>">
		...
		<div class="flex-1 flex flex-col">
			...
			<div class="flex flex-col flex-1 mt-auto justify-end">
				<?php
				$today = new DateTime();
				...
				?>
					<div
						class="flex items-center <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'gap-4' : ' text-xs gap-2' ?>">
