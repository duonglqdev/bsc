<?php if ($args['data']) {
    $news = $args['data'];
?>
    <div class="post_item font-Helvetica flex flex-col <?php echo !wp_is_mobile() && !bsc_is_mobile() ?'':'shadow-[0px_4px_6px_0px_rgba(0,0,0,0.07)] rounded-lg overflow-hidden w-full block_slider-item' ?>">
