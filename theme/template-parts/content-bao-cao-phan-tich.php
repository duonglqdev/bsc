	...
	<div
		...
		<?php if (! wp_is_mobile() && ! bsc_is_mobile()) { ?>
			<div class="flex items-center justify-between mt-auto">
				...
				?>
					<a href="<?php echo $url_download ?>" target="_blank" class="inline-flex items-center gap-3 text-green font-bold transition-all duration-500 hover:scale-105
						 <?php if ($count_download)
								echo 'bsc_up-download' ?>
						" <?php if ($count_download) { ?> data-id="<?php echo $news->id; ?>" <?php
																							}
																								?>>
