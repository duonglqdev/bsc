...
?>
<div class="bg-gradient-blue-200 flex flex-col h-full font-Helvetica expert_item <?php echo ! wp_is_mobile() && ! bsc_is_mobile() ? 'rounded-2xl py-6 gap-4 px-[12px]' : 'rounded-xl py-[12px] gap-2 px-2' ?>"
