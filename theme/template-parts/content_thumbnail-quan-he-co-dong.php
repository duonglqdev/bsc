<?php if ($args['data']) {
    $news = $args['data'];
?>
    <div class="flex flex-col document_item-popup cursor-pointer" data-modal-target="document-modal" data-modal-toggle="document-modal" data-doccument="<?php echo slug_file_news(htmlspecialchars($news->newsid)) ?>" data-id="<?php echo $news->newsid ?>">
        <p
