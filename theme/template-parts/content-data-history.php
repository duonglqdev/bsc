...
?>
    <tr class="[&:nth-child(even)]:bg-[#EBF4FA]">
        ...
        <td class="text-right !pr-8"><?php echo number_format($record['CLOSE_PRICE']) ?></td>
        ...
        <td class="text-right !pr-5"><?php echo number_format($record['TOT_VOLUME']) ?></td>
        <td class="text-right !pr-8"><?php echo number_format($record['TOT_VALUE'], 2, '.', ',') ?></td>
        <td class="text-right !pr-5"><?php echo number_format($record['TOT_PT_VOLUME']) ?></td>
        <td class="text-right !pr-8"><?php echo number_format($record['TOT_PT_VALUE'], 2, '.', ',') ?></td>
        <td class="text-right"><?php echo number_format($record['REF_PRICE']) ?></td>
        <td class="text-right"><?php echo number_format($record['CEILING_PRICE']) ?></td>
        <td class="text-right"><?php echo number_format($record['FLOOR_PRICE']) ?></td>
    </tr>
<?php } ?>