...
?>
    <tr class="[&:nth-child(even)]:bg-[#EBF4FA] text-right">
        ...
        <td class="!pr-5"><?php echo bsc_number_format($record['TOT_VOLUME']) ?></td>
        <td class="!pr-8"><?php echo bsc_number_format($record['TOT_VALUE']) ?></td>
        <td class="!pr-5"><?php echo bsc_number_format($record['TOT_PT_VOLUME']) ?></td>
        <td class="!pr-8"><?php echo bsc_number_format($record['TOT_PT_VALUE']) ?></td>
        <td><?php echo bsc_number_format($record['REF_PRICE']) ?></td>
        <td><?php echo bsc_number_format($record['CEILING_PRICE']) ?></td>
        <td><?php echo bsc_number_format($record['FLOOR_PRICE']) ?></td>
    </tr>
<?php } ?>