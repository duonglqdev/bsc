    ...
    window.handleChart = function(seriesData, xAxisCategories, yAxisOptions) {
        ...
        if (chartElement) {
            var options = {
                ...
                series: seriesData, // Nhận dữ liệu series từ tham số
                xaxis: {
                    categories: xAxisCategories, // Nhận dữ liệu xaxis từ tham số
                },
                yaxis: yAxisOptions, // Nhận dữ liệu yaxis từ tham số
                stroke: {
                    curve: 'smooth',
                    width: 2,
                },
