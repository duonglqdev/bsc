...
(function($) {
    ...
    function aboutUsSlider() {
        ...
        $('.about_history-nav').slick({
            ...
            dots: false,
            prevArrow: '<button class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg></button>',
            nextArrow: '<button class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8.59 16.59L10 18l6-6-6-6-1.41 1.41L13.17 12z"/></svg></button>',
            focusOnSelect: true,
            infinite: false,
            responsive: [{
                    breakpoint: 1024,
    ...
    function toggleContent() {
        ...
        $(document).click(function(e) {
            if (!$(e.target).closest('.open-utilities, .open-utilities-box')
                .length
            ) {
                $('.open-utilities-box').hide(350);
        ...
        function updateChart(
            ...
            const chartData = [{
                    ...
                    data: filteredDateRange.map((date) => ({
                        ...
                        y: stocksData[dataType] &&
                            stocksData[dataType][date] &&
                            stocksData[dataType][date].portclose != null ?
                            stocksData[dataType][date].portclose : null,
                        percentagedifference: stocksData[dataType] &&
                            stocksData[dataType][date] &&
                ...
                },
                {
                    ...
                    data: filteredDateRange.map((date) => ({
                        ...
                        y: stocksData['HOSE'] &&
                            ...
                            stocksData['HOSE'][date].portclose != null ?
                            stocksData['HOSE'][date].portclose : null,
                        percentagedifference: stocksData['HOSE'] &&
                            stocksData['HOSE'][date] &&
                ...
                },
                {
                    ...
                    data: filteredDateRange.map((date) => ({
                        x: new Date(date).getTime(),
                        y: stocksData['VNDIAMOND'] &&
                            stocksData['VNDIAMOND'][date] &&
                            stocksData['VNDIAMOND'][date].portclose != null ?
                            stocksData['VNDIAMOND'][date].portclose : null,
                        percentagedifference: stocksData['VNDIAMOND'] &&
                            stocksData['VNDIAMOND'][date] &&
                            stocksData['VNDIAMOND'][date]
                            .percentagedifference != null ?
                            stocksData['VNDIAMOND'][date]
    ...
    function forecastChart() {
        ...
        if (chartElement) {
            ...
            const stockData = JSON.parse(chartElement.getAttribute('data-stock'));
            ...
            const options = {
                ...
                title: {
                    ...
                    align: 'center',
                    style: { fontSize: '18px', fontWeight: 'bold', color: '#235BA8' },
                },
                series: [{
                        name: 'VN-Index',
